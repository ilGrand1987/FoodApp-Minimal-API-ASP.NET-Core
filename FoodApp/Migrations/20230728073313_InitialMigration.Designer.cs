...
namespace FoodApp.Migrations
{
    ...
    [Migration("20230728073313_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodApp.Entities.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FoodApp.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("DishIngredient", b =>
                {
                    b.HasOne("FoodApp.Entities.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodApp.Entities.Ingredient", null)
                        .WithMany()
